...
public class TestThirdPersonCamera : MonoBehaviour {
	...
	[Range(0.001f, 100f)]public float distance = 7.0f;
...
//		}
	...
	public float TestMvSpeed = 0.001f;
	void TestMoveObj()
	{
		transform.position += transform.forward * TestMvSpeed;
	}
	...
	void SetUpRotation (Vector3 centerPos, Vector3 headPos)
	{
		...
		var centerRay = cameraTransform.camera.ViewportPointToRay(new Vector3(0.5f, 0.5f, 1f));
		var topRay = cameraTransform.camera.ViewportPointToRay(new Vector3(0.5f, clampHeadPositionScreenSpace, 1f));
